define(['showcase/module'], function (module) {
	...
	module.registerController('gridListCtrl', ['$scope', function ($scope) {
    ...
    $mdIconProvider.iconSet("avatar", 'styles/img/icons/avatar-icons.svg', 128);
  })
})